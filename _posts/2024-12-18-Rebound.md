---
title: Rebound
description: An in-depth walkthrough of hacking an extremely challenging Active Directory machine on Hack The Box. This guide takes you through advanced penetration testing techniques, including initial enumeration, vulnerability exploitation, and privilege escalation, to successfully compromise the machine at an insane difficulty level.
author: bilash
category:
- CTF
- ActiveDirectory
...
image:
  ...
  alt: Rebound machine logo from hack the box
---

# Rebound – Hack The Box Walkthrough

**Difficulty:** Insane  
**Target:** Windows  
**Environment:** Active Directory  
**Exploitation Techniques:** AS-REP Roasting, Kerberoasting, ACL Abuse, Descendant Object Takeover (DOT), ShadowCredentials, Cross-Session Relay, NetNTLMv2 Cracking, Resource-Based Constrained Delegation (RBCD), DCSync
